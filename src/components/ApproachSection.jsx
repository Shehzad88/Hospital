...
import approachImg from "../assets/31.jpg"; // import image from src/assets

const steps = [
  { title: "Consultation and Assessment", step: "STEP 1" },
  { title: "Personalized Treatment Plan", step: "STEP 2" },
  { title: "Therapeutic Interventions", step: "STEP 3" },
  { title: "Ongoing Support and Progress", step: "STEP 4" },
];
      ...
      <div className="mt-16 flex flex-col md:flex-row justify-between items-center gap-10">
        {steps.map((item, idx) => (
          <div key={idx} className="flex flex-col items-center text-center relative">
            ...
            {idx !== steps.length - 1 && (
              <div className="hidden md:block absolute right-[-40px] top-6 text-gray-400 text-xl">
                →
              </div>
            )}
          </div>
