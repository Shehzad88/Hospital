    ...
    <div className="min-h-screen bg-white px-8 py-12 font-sans">
      ...
      <form className="space-y-10 max-w-6xl mx-auto">
        ...
        <div className="flex justify-between gap-4">
          <button
            type="button"
            className="w-full py-3 cursor-pointer bg-lime-600 text-white font-medium hover:bg-lime-700 transition rounded-md"
          >
            Preview
          </button>
          <button
          ...
          <button
            type="submit"
            className="w-full py-3 cursor-pointer bg-black text-white font-medium hover:bg-gray-800 transition rounded-md"
          >
            Book an appointment
          </button>
        </div>
